...
* 서버를 실행하고 메인 페이지에 접속하면 일부 항목들의 콘텐츠의 썸네일이 노출됩니다.
    * `http://127.0.0.1:5000/`

![main page](images/main_page.png)

* 스크롤을 하단으로 내리면 항목들의 썸네일이 추가로 노출됩니다.
* 썸네일을 클릭하면 콘텐츠 상세 페이지로 이동합니다.
...
* 콘텐츠 이용시간은 썸네일 클릭 이후 콘텐츠 상세페이지에 머무는 시간의 합으로 정의하였습니다.
...
* 상세페이지로 이동하였을 때, $\lambda$의 사전분포는 다음과 같이 업데이트 된다.
    ...
    * $\beta\leftarrow\beta+\text{상세페이지에 머문 시간}$
